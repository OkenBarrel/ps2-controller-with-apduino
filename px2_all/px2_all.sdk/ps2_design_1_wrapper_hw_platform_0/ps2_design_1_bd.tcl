...
################################################################
# This is a generated script based on design: ps2_design_1
#
...
# source ps2_design_1_script.tcl
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set down [ create_bd_port -dir O down ]
  set l1 [ create_bd_port -dir O l1 ]
  set l2 [ create_bd_port -dir O l2 ]
  set left [ create_bd_port -dir O left ]
  ...
  set right [ create_bd_port -dir O right ]
  set sclk [ create_bd_port -dir O sclk ]
  set scs [ create_bd_port -dir O scs ]
  set smosi [ create_bd_port -dir O smosi ]
  set spi_miso [ create_bd_port -dir I spi_miso ]
  set square [ create_bd_port -dir O square ]
  set triangle [ create_bd_port -dir O triangle ]
  set up [ create_bd_port -dir O up ]
  set x [ create_bd_port -dir O x ]

  # Create instance: axi_gpio_0, and set properties
  set axi_gpio_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 axi_gpio_0 ]
  set_property -dict [ list CONFIG.C_ALL_INPUTS_2 {1} CONFIG.C_ALL_OUTPUTS {1} CONFIG.C_GPIO2_WIDTH {1} CONFIG.C_GPIO_WIDTH {12} CONFIG.C_IS_DUAL {0}  ] $axi_gpio_0
...
CONFIG.PCW_WDT_PERIPHERAL_FREQMHZ {133.333333} CONFIG.PCW_WDT_WDT_IO {<Select>} \
  ...
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M01_AXI [get_bd_intf_pins processing_system7_0_axi_periph/M01_AXI] [get_bd_intf_pins px2_game_0/S00_AXI]
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M02_AXI [get_bd_intf_pins processing_system7_0_axi_periph/M02_AXI] [get_bd_intf_pins test_new2_0/S00_AXI]

  # Create port connections
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0_axi_periph/ACLK] [get_bd_pins processing_system7_0_axi_periph/M00_ACLK] [get_bd_pins processing_system7_0_axi_periph/M01_ACLK] [get_bd_pins processing_system7_0_axi_periph/M02_ACLK] [get_bd_pins processing_system7_0_axi_periph/M03_ACLK] [get_bd_pins processing_system7_0_axi_periph/S00_ACLK] [get_bd_pins px2_game_0/s00_axi_aclk] [get_bd_pins rst_processing_system7_0_100M/slowest_sync_clk] [get_bd_pins test_new2_0/s00_axi_aclk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_processing_system7_0_100M/ext_reset_in]
  connect_bd_net -net px2_game_0_down [get_bd_ports down] [get_bd_pins px2_game_0/down]
  connect_bd_net -net px2_game_0_l1 [get_bd_ports l1] [get_bd_pins px2_game_0/l1]
  connect_bd_net -net px2_game_0_l2 [get_bd_ports l2] [get_bd_pins px2_game_0/l2]
  connect_bd_net -net px2_game_0_left [get_bd_ports left] [get_bd_pins px2_game_0/left]
  connect_bd_net -net px2_game_0_o [get_bd_ports o] [get_bd_pins px2_game_0/o]
  connect_bd_net -net px2_game_0_r1 [get_bd_ports r1] [get_bd_pins px2_game_0/r1]
  connect_bd_net -net px2_game_0_r2 [get_bd_ports r2] [get_bd_pins px2_game_0/r2]
  connect_bd_net -net px2_game_0_right [get_bd_ports right] [get_bd_pins px2_game_0/right]
  connect_bd_net -net px2_game_0_sclk [get_bd_ports sclk] [get_bd_pins px2_game_0/sclk]
  connect_bd_net -net px2_game_0_scs [get_bd_ports scs] [get_bd_pins px2_game_0/scs]
  connect_bd_net -net px2_game_0_smosi [get_bd_ports smosi] [get_bd_pins px2_game_0/smosi]
  connect_bd_net -net px2_game_0_square [get_bd_ports square] [get_bd_pins px2_game_0/square]
  connect_bd_net -net px2_game_0_triangle [get_bd_ports triangle] [get_bd_pins px2_game_0/triangle]
  connect_bd_net -net px2_game_0_up [get_bd_ports up] [get_bd_pins px2_game_0/up]
  connect_bd_net -net px2_game_0_x [get_bd_ports x] [get_bd_pins px2_game_0/x]
  connect_bd_net -net rst_processing_system7_0_100M_interconnect_aresetn [get_bd_pins processing_system7_0_axi_periph/ARESETN] [get_bd_pins rst_processing_system7_0_100M/interconnect_aresetn]
  connect_bd_net -net rst_processing_system7_0_100M_peripheral_aresetn [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins processing_system7_0_axi_periph/M00_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M01_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M02_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M03_ARESETN] [get_bd_pins processing_system7_0_axi_periph/S00_ARESETN] [get_bd_pins px2_game_0/s00_axi_aresetn] [get_bd_pins rst_processing_system7_0_100M/peripheral_aresetn] [get_bd_pins test_new2_0/s00_axi_aresetn]
  connect_bd_net -net spi_miso_1 [get_bd_ports spi_miso] [get_bd_pins px2_game_0/spi_miso]
  connect_bd_net -net test_new2_0_music [get_bd_ports music] [get_bd_pins test_new2_0/music]
  ...
  create_bd_addr_seg -range 0x10000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs px2_game_0/S00_AXI/S00_AXI_reg] SEG_px2_game_0_S00_AXI_reg
  create_bd_addr_seg -range 0x10000 -offset 0x43C10000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs test_new2_0/S00_AXI/S00_AXI_reg] SEG_test_new2_0_S00_AXI_reg
